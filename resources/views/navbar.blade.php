<nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color:#dadd32;">

    <h2 class="p-2 text-white" style="font-size:23px; font-weight:400;"><span class="fas fa-comments"></span>About Anime</h2>
        ...
        <ul class="navbar-nav d-flex align-items-end justify-content-end">
            <li class="nav-item">
                <a class="nav-link text-white {{ 'dashboard' == request()->path() ? 'active' : '' }}"
                    href="{{ '/dashboard' }}"><span class="fas fa-dashboard"></span>Anime Discussion</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ 'recent-post' == request()->path() ? 'active' : '' }}"
                    href="{{ '/recent-post' }}"><span class="fas fa-commenting-o"></span>Recent Anime Discussion</a>
            </li>
            ...
            @role('admin')
                ...
                <div class="dropdown">
                    <a class="btn dropdown-toggle text-warning bg-primary bg-opacity-75" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><span class="fas fa-lock"></span>
                        Admin
                    </a>
                    <div class="dropdown-menu bg-warning bg-opacity-75" aria-labelledby="dropdownMenuButton" id="select3">
